...
<table>
	...
	<tr>
		...
		<td>preview</td>
	<td><a href='#blue_event_slo'> <span style='color:purple'>BLUE_EVENT_SLO</span></a></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Service Profile Connection '${connection_name}' state changed to deporvisioned</td>
		<td>preview</td>
	<td><a href='#blue_event_slo'> <span style='color:purple'>BLUE_EVENT_SLO</span></a></td>
	</tr>
	<tr>
...
---
### Equinix IAM ActionAuthorizedEvent
#### DataSchema [JSON](https://equinix.github.io/equinix-cloudevents/jsonschema/equinix/iam/v1/ActionAuthorizedEvent.json)
#### Data Type
`equinix.iam.v1.ActionAuthorizedEvent`
#### Supported Events, Metrics, and Alerts
#### Events
